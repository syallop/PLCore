...
deriving instance (Document b,Document abs,Document tb,Document expr) => Document (ExprF b abs tb expr)
...
checkMatchWith
  :: (Binds b (Type tb),Binds tb Kind,Ord tb,Document tb)
  => MatchArg b tb
  -> Type tb
  -> ExprBindCtx b tb
  -> TypeBindCtx tb
